...
Pass the label "ack" in the json structure with either a true or false value to trigger
the delete method of the "ack" label in the console which can remotely indicate receipt
of LED state change command

.. code-block:: console

   goliothctl lightdb set <device-id> /led -b '{"0":true,"1":false,"2":true,"3":true,"ack":true}'

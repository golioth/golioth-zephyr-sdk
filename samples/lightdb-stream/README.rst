...
This Light DB Stream application demonstrates how to connect with Golioth and save historical data on Light DB Stream.
...
.. code-block:: console
   ...
   $ west build -b qemu_x86 samples/lightdb-stream
   $ west build -t run
...
.. code-block:: console
   ...
   $ west build -b esp32 samples/lightdb-stream
   $ west flash
